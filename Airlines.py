...
Label(fr2,text="Anand and Yogesh (20100BTCSEMA07363)",font=("Bauhaus 93",14),fg="Red",compound="center").pack()
...
def airline():
    ...
    w = OptionMenu(root1, variable, "Indore", "Aurangabad", "Nagpur", "Pune", "Delhi", "Kolkata", "Mumbai","U.S.A","Canada")
    ...
    w = OptionMenu(root1, variable1, "Indore", "Aurangabad", "Nagpur", "Pune", "Delhi", "Kolkata", "Mumbai","U.S.A","Canada")
